...
public class EditHoursController implements Initializable
{
	...
	@FXML private ChoiceBox<String> openH;
	@FXML private ChoiceBox<String> openM;
	@FXML private ChoiceBox<String> closeH;
	@FXML private ChoiceBox<String> closeM;
	
	@FXML private ChoiceBox<String> day;
	@FXML private ChoiceBox<String> opened;
	...
	public void handleSave()
	{
		...
		{
			GUIAlert.infoBox("Save Successful", "Save");
		}
		else
		{
			GUIAlert.infoBox("Something went wrong!", "Save");
		}
	}
