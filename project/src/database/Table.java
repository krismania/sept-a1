...
/**
 * Representative object of an SQL table. The {@code toString()} method gives the
 * SQL required to create the represented table.
 * @author krismania
 */
class Table
{
	...
	/**
	 * Add a column with the given name, of given type.
	 * Type may me any SQL type, such as {@code varchar(30)} or {@code date}
	 */
	...
	/**
	 * Sets the primary column of the table. If the string passed is not the name
	 * of a column in the table, it will cause an SQL error.
	 */
	 ...
	 * @param columnName the column to constrain
	 * @param reference the column to constrain based on.
	 */
	...
	/**
	 * Returns the table specified by this object an SQL {@code CREATE TABLE} statement.
	 */
	@Override
