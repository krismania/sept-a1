...
public class Console
{
    ...
    /*TN - Display method with hard coded values. Will make more generic and will display
    * persistent data polymorphically in a later implementation - pendnigmethod for setting appointments */
